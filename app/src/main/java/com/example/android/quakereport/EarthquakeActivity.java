...
/*Then we need to look up the user’s preferred sort order when we build the URI for making
 the HTTP request. Read from SharedPreferences and check for the value associated with the
  key: getString(R.string.settings_order_by_key). When building the URI and appending query
